...
namespace AppRDV
{
    ...
    public static class Encriptador
    {
        ...
        public static class RijndaelSimple
        {
            ...
            public static string Encriptar(string pvc_Value)
            {

                return Encriptar(pvc_Value,
            ...
            public static string Desencriptar(string pvc_Value)
            {

                return Desencriptar(pvc_Value, "pass75dc@avz10", "s@lAvz", "MD5",
